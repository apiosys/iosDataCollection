...
@interface STSensorManager()
	...
	@property(nonatomic, strong) STAltimiterMonitor *altimiterMonitor;
...
@synthesize altimiterMonitor = _altimiterMonitor;
...
-(STAltimiterMonitor *)altimiterSensorMonitor
{
	return self.altimiterMonitor;
}
...
-(STAltimiterMonitor *)altimiterMonitor
{
	if(_altimiterMonitor == nil)
		_altimiterMonitor = [[STAltimiterMonitor alloc]init];
	
	return _altimiterMonitor;
}
...
-(void)stopSensors
{
	...
	[self.altimiterMonitor stopAltimiter:self.motionManager];
...
-(BOOL)startSensors
{
	...
	if([self.altimiterMonitor startAltimiter:self.motionManager] == FALSE)
		NSLog(@"Altimiter Monitoring not available");
...
-(void)startUpNeededSensors
{
	...
	if([self.altimiterMonitor startAltimiter:self.motionManager] == FALSE)
		[self logErrorMessage:@"APP ERROR LOG: Unable to start the altimiter monitoring\n"];
