...
static const NSString * WALKING_INCLUDE_IN_LOG_KEY =@"WALKING_INCLUDE_IN_LOG_KEY";
static const NSString * WALKING_SIDE_KEY = @"WALKING_SIDE_KEY";
static const NSString * WALKING_DEVICE_LOCATION_KEY = @"WALKING_DEVICE_LOCATION_KEY";
static const NSString * VEHICLE_INCLUDE_IN_LOG_KEY = @"VEHICLE_INCLUDE_IN_LOG_KEY";
static const NSString * VEHICLE_SIDE_KEY = @"VEHICLE_SIDE_KEY";
static const NSString * VEHICLE_DEVICE_LOCATION_KEY = @"VEHICLE_DEVICE_LOCATION_KEY";
static const NSString * VEHICLE_ENTRY_INCLUDE_IN_LOG_KEY = @"VEHICLE_ENTRY_INCLUDE_IN_LOG_KEY";
static const NSString * VEHICLE_ENTRY_SIDE_KEY = @"VEHICLE_ENTRY_SIDE_KEY";
static const NSString * VEHICLE_ENTRY_END_KEY = @"VEHICLE_ENTRY_END_KEY";
